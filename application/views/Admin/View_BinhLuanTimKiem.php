              ...
              <div class="card-header">
                <form class="row" action="<?php echo base_url('admin/binh-luan/tim-kiem/') ?>"> 
                  <div class="col-sm-2">
                    ...
                    <input type="text" name="tieude" class="form-control" placeholder="Tên bài viết" value="<?php echo $post['tieude']; ?>">
                  </div>
                  <div class="col-sm-2">
              ...
              <div class="card-footer clearfix">
                ...
                <ul class="pagination pagination-sm m-0 float-right">
                  <?php for($i = 1; $i <= $totalPages; $i++){ ?>
                      <li class="page-item"><a class="page-link" href="<?php echo base_url('admin/binh-luan/tim-kiem/'.$i.'/trang/?tieude='.$post['tieude'].'&thoigian='.$post['thoigian']) ?>"><?php echo $i; ?></a></li>
                    <?php } ?>      
                </ul>
              </div>
            </div>
