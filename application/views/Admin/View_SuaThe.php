        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url('admin/loai-the/'); ?>">Quản Lý Thẻ</a></li>
              <li class="breadcrumb-item active"><?php echo $detail[0]['TenThe']; ?></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control tenchinh" id="ten" placeholder="Tên thẻ" name="tenthe" value="<?php echo $detail[0]['TenThe']; ?>">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <select class="form-control" aria-label="Default select example" name="hienthiwidget">
                      <option value="0" <?php echo $detail[0]['HienThiWidget'] == 0 ? "selected" : ""; ?>>Không Hiển Thị</option>
                      <option value="1" <?php echo $detail[0]['HienThiWidget'] == 1 ? "selected" : ""; ?>>Có Hiển Thị</option>
                    </select>
                  </div>
                </div>
              </div> 
