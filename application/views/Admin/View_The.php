            ...
            <div class="card">
              <div class="card-header">
                <form class="row" action="<?php echo base_url('admin/loai-the/tim-kiem/') ?>"> 
                  <div class="col-sm-2">
                    <label>Tên Thẻ</label>
                    <input type="text" name="tenthe" class="form-control" placeholder="Tên thẻ">
                  </div>
                  <div class="col-sm-2">
              ...
              <div class="card-footer clearfix">
                <ul class="pagination pagination-sm m-0 float-right">
                	<?php for($i = 1; $i <= $totalPages; $i++){ ?>
                  		<li class="page-item"><a class="page-link" href="<?php echo base_url('admin/loai-the/'.$i.'/trang/') ?>"><?php echo $i; ?></a></li>
                  	<?php } ?>      
                </ul>
              </div>
            </div>
