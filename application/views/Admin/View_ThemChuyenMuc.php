...
<?php   
function generateOptions($categories, $parentId = NULL, $level = 0) {
    ...
    foreach ($categories as $category) {
        if ($category["ChuyenMucCha"] == $parentId) {
            ...
            echo '<option value="' . $category['MaChuyenMuc'] . '">' . $padding . $category['TenChuyenMuc'] . '</option>';

            // Gọi đệ quy để hiển thị các chuyên mục con của chuyên mục hiện tại
            generateOptions($categories, $category['MaChuyenMuc'], $level + 1);
        }
    }
} 
?>
            ...
            <form method="post" enctype="multipart/form-data">
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <img id="output" style="width: 288px; height: 56px;">
                  <br>
                  <br>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="ten">Hiển Thị Chuyên Mục Trên Menu?</label>
